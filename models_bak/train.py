...
class Train:
	...
	def parse_args(args):
		...
		dataArgs.add_argument('--maxLength', type=int, default=1000, help='max length of samples')

		# neural network options
		nnArgs = parser.add_argument_group('Network options')
		nnArgs.add_argument('--embeddingSize', type=int, default=300)
		nnArgs.add_argument('--hiddenSize', type=int, default=200)
		nnArgs.add_argument('--rnnLayers', type=int, default=1)
		nnArgs.add_argument('--maxSteps', type=int, default=100, help='number of steps in RNN')
		...
		trainingArgs.add_argument('--testBatchSize', type=int, default=20, help='test batch size')
	...
	def train_eager(self):
		...
		for e in range(self.args.epochs):
			trainBatches = self.textData.val_batches
