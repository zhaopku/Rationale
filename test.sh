...
bsub -n 3 -R  "rusage[mem=2048,ngpus_excl_p=1]" python main.py --hiddenSize 100 --maxSteps 30 --dropOut 0.8 --batchSize 100 --preEmbedding --elmo --learningRate 0.001 --epochs 100 --theta 100.0 --gamma 10.0 &&
bsub -n 3 -R  "rusage[mem=2048,ngpus_excl_p=1]" python main.py --hiddenSize 100 --maxSteps 30 --dropOut 0.8 --batchSize 100 --preEmbedding --elmo --learningRate 0.001 --epochs 100 --theta 100.0 --gamma 100.0 &&
