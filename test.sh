...
bsub -W 48:00 -n 3 -R  "select[gpu_model1==GeForceGTX1080Ti] rusage[mem=4096,ngpus_excl_p=1]" python main.py --hiddenSize 100 --maxSteps 500 --vocabSize 50000 --dropOut 0.8 --batchSize 20 --learningRate 0.001 --epochs 100 --theta 1.0 --gamma 1.0
